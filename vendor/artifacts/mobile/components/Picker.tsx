            ...
            ListHeaderComponent={
              allowClear && value ? (
                <Pressable
                  ...
                  style={[styles.clearRow, isRTL && styles.rowRTL]}
                  testID="button-clear-picker"
                >
                  <Feather name="x-circle" size={18} color={colors.danger} />
                  <Text style={styles.clearText}>{t("Effacer la sélection", "مسح الاختيار")}</Text>
                </Pressable>
              ) : null
            }
            renderItem={({ item }) => {
...
const styles = StyleSheet.create({
  ...
  clearRow: { flexDirection: "row", alignItems: "center", gap: 10, paddingVertical: 14, paddingHorizontal: 18, borderBottomWidth: 1, borderBottomColor: colors.border },
