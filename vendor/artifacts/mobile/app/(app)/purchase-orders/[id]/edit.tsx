...
export default function EditPurchaseOrder() {
  ...
  const { data: list, isLoading: listLoading } = useGetPurchaseOrders({
    query: { enabled: ready, queryKey: getGetPurchaseOrdersQueryKey() },
  });
  ...
  const { data: suppliersData, isSuccess: suppliersLoaded } = useGetSuppliers({
