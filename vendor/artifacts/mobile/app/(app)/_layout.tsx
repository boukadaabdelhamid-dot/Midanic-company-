...
function BrandHeader() {
  return (
    <View style={{ flexDirection: "row", alignItems: "center", gap: 10 }}>
      <View style={{ width: 66, height: 36, backgroundColor: "#fff", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
        <Image source={require("../../assets/images/icon.png")} style={{ width: 62, height: 31 }} resizeMode="contain" />
      </View>
      <Text style={{ color: "#fff", fontSize: 18, fontWeight: "700" }}>Midanic ERP</Text>
    </View>
  );
}
...
export default function AppLayout() {
  return (
    ...
    >
      ...
      <Drawer.Screen name="mon-compte" options={{ title: "Mon compte", headerTitle: () => <BrandHeader /> }} />
      <Drawer.Screen name="orders/index" options={{ title: "Commandes" }} />
      <Drawer.Screen name="pos" options={{ title: "Point de vente" }} />
      ...
      <Drawer.Screen name="retours/[id]" options={{ title: "Détail du retour", drawerItemStyle: { display: "none" } }} />
      <Drawer.Screen name="customers/index" options={{ title: "Clients" }} />
      <Drawer.Screen name="customers/new" options={{ title: "Nouveau client", drawerItemStyle: { display: "none" } }} />
