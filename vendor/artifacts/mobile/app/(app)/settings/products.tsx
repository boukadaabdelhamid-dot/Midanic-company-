...
type TaxonomyTab = "brands" | "families" | "colors" | "types";
...
export default function ProductSettings() {
  ...
  const [activeTab, setActiveTab] = useState<TaxonomyTab>("brands");
  ...
  const tabs: Array<{ key: TaxonomyTab; labelFr: string; labelAr: string }> = [
    { key: "brands", labelFr: "Marques", labelAr: "الماركات" },
    { key: "families", labelFr: "Familles", labelAr: "الفئات" },
    { key: "colors", labelFr: "Couleurs", labelAr: "الألوان" },
    { key: "types", labelFr: "Types", labelAr: "الأنواع" },
  ];
        ...
        {tabs.map((tab) => {
          ...
          return (
            <Pressable
              ...
              testID={`tab-product-settings-${tab.key}`}
            >
              <Text style={[styles.tabLabel, selected && styles.tabLabelActive]}>
                {t(tab.labelFr, tab.labelAr)}
              </Text>
            </Pressable>
          );
        })}
